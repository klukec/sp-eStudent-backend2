...
INSERT INTO `izpitnirok` (`idIzpitniRok`, `idPredmeta`, `stRoka`, `datum`, `prostor`, `komentar`, `zakljucen`) VALUES
	...
	(3, 1, 3, '2015-12-15', 'P22', '10:00', 0),
	(4, 3, 1, '2015-12-15', 'P01', '12:00', 0),
...
INSERT INTO `studentpredmet` (`idStudentPredmet`, `idStudenta`, `idPredmeta`, `opravljen`) VALUES
	(1, 1, 1, 1),
	(2, 1, 2, 0),
	(3, 2, 1, 1),
	(4, 2, 2, 1);
...
INSERT INTO `uporabnik` (`idUporabnik`, `vpisnaStevilka`, `ime`, `priimek`, `email`, `geslo`, `mobi`, `spol`, `letnikStudija`, `datumRegistracije`, `zadnjiDostop`, `idVloge`) VALUES
	(1, 63130164, 'Matic', 'Novak', 'info@makro.si', 'geslo', '041 721 924', 'M', 3, '2015-12-15 11:27:29', '2015-12-15 11:27:33', 1),
	(2, 63130098, 'Tina', 'Klančar', 'klancar.tina@gmail.com', 'geslo2', '070 000 000', 'Z', 2, '2015-12-15 15:55:39', '2015-12-15 15:55:39', 1),
	(3, 63130167, 'Rok', 'Novosel', 'rok@novosel.metlika', 'gesloNesto5', '07 30 88 958', 'M', 3, '2015-12-15 15:56:37', '2015-12-15 15:56:38', 1),
	(4, NULL, 'Gašper', 'Fijavž', 'gasper.fijavz@fri.uni-lj.si', 'nestoGeslo', '01 45 67 415', 'M', NULL, '2015-12-15 15:57:21', '2015-12-15 15:57:27', 2),
	(5, NULL, 'Polona', 'Oblak', 'polona.oblak@fri.uni-lj.si', 'soncek', '01 58 74 614', 'Z', NULL, '2015-12-15 16:08:14', '2015-12-15 16:08:14', 2),
	(6, NULL, 'Studentski', 'referat', 'referat@fri.uni-lj.si', 'referat5', '01 47 65 147', 'M', NULL, '2015-12-15 16:09:05', '2015-12-15 16:09:05', 3);
