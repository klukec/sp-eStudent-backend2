...
-- Dumping data for table estudent.izpitnirok: ~4 rows (približno)
...
-- Dumping data for table estudent.ocena: ~2 rows (približno)
DELETE FROM `ocena`;
...
-- Dumping data for table estudent.studentpredmet: ~4 rows (približno)
...
-- Dumping data for table estudent.uporabnik: ~6 rows (približno)
...
INSERT INTO `uporabnik` (`idUporabnik`, `vpisnaStevilka`, `ime`, `priimek`, `email`, `geslo`, `mobi`, `spol`, `letnikStudija`, `datumRegistracije`, `zadnjiDostop`, `idVloge`) VALUES
	...
	(6, NULL, 'Studentski', 'referat', 'referat@gmail.com', 'referat5', '01 47 65 147', 'M', NULL, '2015-12-15 16:09:05', '2015-12-15 16:09:05', 3),
